...
namespace Skyblivion.OBSLexicalParser.TES5.Factory.Functions
{
    class GetPCFactionStealFactory : IFunctionFactory
    {
        ...
        public ITES5CodeChunk convertFunction(ITES5Referencer calledOn, TES4Function function, TES5CodeScope codeScope, TES5GlobalScope globalScope, TES5MultipleScriptsScope multipleScriptsScope)
        {
            ...
            TES5ArithmeticExpression rightExpression = this.expressionFactory.createArithmeticExpression(crimeGoldNonViolent, TES5ArithmeticExpressionOperator.OPERATOR_GREATER, new TES5Integer(0));
            TES5LogicalExpression logicalExpression = this.expressionFactory.createLogicalExpression(leftExpression, TES5LogicalExpressionOperator.OPERATOR_AND, rightExpression);
