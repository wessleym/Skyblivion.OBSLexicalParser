...
{
    class IsPCAMurdererFactory : IFunctionFactory
    {
        ...
        public IsPCAMurdererFactory(TES5ValueFactory valueFactory, TES5ObjectCallFactory objectCallFactory, TES5ObjectCallArgumentsFactory objectCallArgumentsFactory, TES5ReferenceFactory referenceFactory, TES5ObjectPropertyFactory objectPropertyFactory, ESMAnalyzer analyzer,TES5TypeInferencer typeInferencer, MetadataLogService metadataLogService)
        {
        ...
        {
            return this.objectCallFactory.CreateObjectCall(TES5StaticReference.Game, "IsPCAMurderer", multipleScriptsScope);
        }
    }
}