...
{
    class ResurrectFactory : IFunctionFactory
    {
        ...
        public ResurrectFactory(TES5ValueFactory valueFactory, TES5ObjectCallFactory objectCallFactory, TES5ObjectCallArgumentsFactory objectCallArgumentsFactory, TES5ReferenceFactory referenceFactory, TES5ObjectPropertyFactory objectPropertyFactory, ESMAnalyzer analyzer,TES5TypeInferencer typeInferencer, MetadataLogService metadataLogService)
        {
        ...
        {
            return this.objectCallFactory.CreateObjectCall(calledOn, "Resurrect", new TES5ObjectCallArguments());
        }
    }
}