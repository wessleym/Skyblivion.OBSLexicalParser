...
namespace Skyblivion.OBSLexicalParser.TES5.Factory.Functions
{
    class IsPCSleepingFactory : IFunctionFactory
    {
        ...
        {
            return this.expressionFactory.createArithmeticExpression(this.objectCallFactory.createObjectCall(this.referenceFactory.createReferenceToPlayer(), "getSleepState", multipleScriptsScope), TES5ArithmeticExpressionOperator.OPERATOR_GREATER, new TES5Integer(2));
        }
    }
}