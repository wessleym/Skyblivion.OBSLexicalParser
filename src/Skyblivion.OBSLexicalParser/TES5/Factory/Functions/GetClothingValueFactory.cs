...
namespace Skyblivion.OBSLexicalParser.TES5.Factory.Functions
{
    class GetClothingValueFactory : IFunctionFactory
    {
        ...
        public ITES5ValueCodeChunk ConvertFunction(ITES5Referencer calledOn, TES4Function function, TES5CodeScope codeScope, TES5GlobalScope globalScope, TES5MultipleScriptsScope multipleScriptsScope)
        {
            ...
            return this.objectCallFactory.CreateObjectCall(this.objectCallFactory.CreateObjectCall(calledOn, "GetWornForm", getArmorWornArg), "GetGoldValue", comment: function.Comment);
        }
    }
}