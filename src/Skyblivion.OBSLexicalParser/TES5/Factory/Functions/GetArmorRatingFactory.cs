...
namespace Skyblivion.OBSLexicalParser.TES5.Factory.Functions
{
    class GetArmorRatingFactory : IFunctionFactory//WTM:  Change:  Added (SKSE)
    {
        ...
        {
            TES5FunctionCodeBlock functionCodeBlock = new TES5FunctionCodeBlock(new TES5FunctionScope(functionName), new TES5CodeScope(codeScope.LocalScope), TES5BasicType.T_INT);
