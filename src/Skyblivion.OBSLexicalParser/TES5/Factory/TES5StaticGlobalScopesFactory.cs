...
namespace Skyblivion.OBSLexicalParser.TES5.Factory
{
    static class TES5StaticGlobalScopesFactory
    {
        public static List<TES5GlobalScope> createGlobalScopes()
        {
            ...
            globalScopes.Add(new TES5GlobalScope(new TES5ScriptHeader("TES4TimerHelper", TES5BasicType.T_QUEST, "")));
            TES5GlobalScope globalScope = new TES5GlobalScope(new TES5ScriptHeader("TES4Container", TES5BasicType.T_QUEST, ""));
