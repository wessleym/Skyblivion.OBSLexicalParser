...
namespace Skyblivion.OBSLexicalParser.TES4.Parsers
{
    class TES4ObscriptCodeGrammar : Grammar
    {
        ...
        protected void CreateObscriptCodeParsingTree()
        {
            ...
            {
                return new TES4CodeChunks() { codeDeclaration };
            });
...
//todo-THIS should be fixed on lexer level, right now it ignores NWL after the return
            ...
            ;
            __invoke("LocalVariableDeclaration").Is("LocalVariableDeclarationType", "VariableName").Call((CommonToken variableDeclarationType, CommonToken variableName) =>
            {
            ...
            ;
            __invoke("MathOperator").Is("==").Call((CommonToken op) =>
            {
            ...
            ;
            __invoke("LogicalOperator").Is("||").Call((CommonToken op) =>
            {
            ...
            __invoke("BinaryOperator").Is("+").Call((CommonToken op) =>
            {
            ...
            __invoke("Primitive").Is("Float").Call((CommonToken fl) =>
            {
