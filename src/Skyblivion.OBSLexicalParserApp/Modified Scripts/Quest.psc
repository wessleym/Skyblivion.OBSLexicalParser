...
; Resets the 0x13A field on TESQuest, allowing it to be started again. Use if you want to start a quest which was already stopped.
bool Function PrepareForReinitializing() native
