...
;Skyblivion IsTorchOut() impl
Bool Function IsTorchOut() native

;Skyblivion GetRestrained() impl
Bool Function GetRestrained() native

; Adds the specified perk to this actor
Float Function ObSay(topic TopicID, Actor speakTo) native